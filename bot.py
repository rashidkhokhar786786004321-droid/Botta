...
# ========= CONFIG =========
BOT_TOKEN = "8487619607:AAHBJwRp2Yw58ZGsAZXOiReuXbuSWAjBjo8"  # Token direct add
PKG_API_BASE = "http://musa699.serv00.net/pkg.php?number="
Telegram_Channal = "https://t.me/Musa_x2"  # Correct channel link
Sport_GROUP = "https://t.me/Discuss_group33"  # Correct group link

# oopk.online OTP verify endpoint
...
def menu_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("⚡ Telegram Channel ↗", url=Telegram_Channal),
            InlineKeyboardButton("🌐 Telegram Group ↗", url=Sport_GROUP),
        ],
    ])
...
if __name__ == "__main__":
    main()STATE = defaultdict(dict)  # ephemeral per-process
AWAITING_NUMBER_FOR_OTP = "awaiting_number_for_otp"
AWAITING_OTP = "awaiting_otp"
AWAITING_NUMBER_FOR_PKG = "awaiting_number_for_pkg"
